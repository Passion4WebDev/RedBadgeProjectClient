...
const Register = (props) => {
  ...
  let handleSubmit = (event) => {
    console.log('handle sub activated')
    event.preventDefault();
    fetch('http://localhost:3200/user/register', {
      method: 'POST',
  ...
  return(
    <div>
      <h3 className="RegisterMain">Register</h3>
      <Form onSubmit={handleSubmit}>
        ...
        <br/>
        <Button className="authButton" type='submit' color="warning">Join The Exotic Super CarsXXXX</Button>
      </Form>
    </div>
  )
}
